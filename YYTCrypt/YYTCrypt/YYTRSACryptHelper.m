...
#define OpenSSLRSAPublicKeyFile [OpenSSLRSAKeyDir stringByAppendingPathComponent:@"yytaxi.publicKey.pem"]
#define OpenSSLRSAPrivateKeyFile [OpenSSLRSAKeyDir stringByAppendingPathComponent:@"yytaxi.privateKey.pem"]

#import "YYTRSACryptHelper.h"

@implementation YYTRSACryptHelper
...
{
    NSAssert(_rsaPublic != NULL, @"公钥未找到，请导入公钥");
...
{
    NSAssert(_rsaPrivate != NULL, @"私钥未找到，请导入私钥");
